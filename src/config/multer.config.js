...
/**
 * Crea una instancia de Multer configurada para una subcarpeta específica.
 * @param {string} subfolder - Nombre de la subcarpeta dentro de 'uploads/'
 * @returns {multer.Multer} - Instancia de Multer
 */
